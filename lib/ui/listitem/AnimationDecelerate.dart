...
class AnimationDecelerate extends StatefulWidget {
  static Future launcher(BuildContext context) {
    return Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => AnimationDecelerate()),
    );
  }

  AnimationDecelerate({Key key}) : super(key: key);

  @override
  _AnimationDecelerate createState() => _AnimationDecelerate();
}

class _AnimationDecelerate extends State<AnimationDecelerate>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(ViewType.VT_ANIMATION_DECELERATE),
      ),
